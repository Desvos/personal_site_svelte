...
<div class="row justify-content-center">
    <div class="col-12 col-lg-3 text-center">
        <img alt="pfp" src="/pfp1.jpg" class="pfp-t1" />
    </div>
    <div class="col-12 col-lg-5 pt-7 main-description">
        <span style="color: grey;">Fullstack Software Engineer</span><br>
        <h1>Antonio De Vivo</h1>
